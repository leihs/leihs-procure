Feature: Create, read, update, delete, etc.
  ...
  Scenario: Short ID
    ...
    And I set the start date as "01.01.3000" on line 1
    And I set the end date as "30.06.3000" on line 1
    ...
    And I click on "Budgetperioden"
    And I set the name as of the budget period "3000" to "3XXX"
    And I click on "Speichern"

    ### create a new request in this budget period ###
    When I click on "Anträge"
    And I refresh the page
    And I click on + for budget period "3XXX"
    And I click on + for category "Category C1"
    And I enter the following data into the request form:
      | field                         | value         |
      | Artikel oder Projekt          | Camera X      |
      ...
      | Menge beantragt               | 5             |
    And I click on 'Speichern'
    Then I see short ID "3XXX.001"

    ### create a budget period for the old name"
    And I click on "Admin"
    And I click on "Budgetperioden"
    And I click on the + button
    And I set the name as "3000" on line 2
    And I set the start date as "01.07.3000" on line 2
    And I set the end date as "31.12.3000" on line 2
    And I click on "Speichern"

    ### create a new request in the budget period with the old name ###
    When I click on "Anträge"
    And I refresh the page
    And I select budget period "3000"
    And I click on + for budget period "3000"
